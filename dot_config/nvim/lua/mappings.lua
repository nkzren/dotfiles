...
map("n", "<C-h>", "<cmd>resize +5<cr>", { desc = "Increase window height" })
map("n", "<C-j>", "<cmd>resize -5<cr>", { desc = "Decrease window height" })
map("n", "<C-k>", "<cmd>vertical resize +5<cr>", { desc = "Decrease window width" })
map("n", "<C-l>", "<cmd>vertical resize -5<cr>", { desc = "Increase window width" })
